  ...
  !
  REAL (KIND=DP) :: meff
  !! average effective mass (in unit of the electron mass)
  ...
  !! smearing for the RPA dielectric function (in eV)
  !
  !LOGICAL :: tphases
  ...
  LOGICAL :: lscreen
  !! if .true. enables screening of the e-ph matrix elements
  LOGICAL :: wfcelec
...
MODULE output_epw
  ...
  CHARACTER (LEN=80) :: filrm
  !! input  file for real space mesh
