  ...
  USE epwcom,        ONLY : epexst, epbwrite, ep_coupling, &
                            ...
                            filrm, fileig, fila2f, fermi_energy, &
                            ...
                            specfun, lscreen, meff, fermi_diff, n_dop, smear_rpa, &
                            rand_q, rand_nq, rand_nk, rand_k, pwc, phonselfen, &
                            parallel_q, parallel_k, wfcelec, &
...
!  CALL mp_bcast (tphases, ionode_id, world_comm)   !
  ...
  CALL mp_bcast (lscreen, ionode_id, world_comm)
  ...
  CALL mp_bcast (wfcelec, ionode_id, world_comm)
  !
  ! integers
  !
  ...
  CALL mp_bcast (meff, ionode_id, world_comm)
  CALL mp_bcast (fermi_diff, ionode_id, world_comm)
  CALL mp_bcast (n_dop, ionode_id, world_comm)
  CALL mp_bcast (smear_rpa, ionode_id, world_comm)
  !
  ! characters
  !
...
!  CALL mp_bcast (fildvscf0, ionode_id, world_comm) !
  ...
  CALL mp_bcast (filrm, ionode_id, world_comm)    ! CV
#endif
  !
