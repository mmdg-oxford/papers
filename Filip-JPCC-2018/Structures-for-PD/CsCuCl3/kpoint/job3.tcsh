...
cp cscucl3-scf.in cscucl3-scf-${NLINE}.in
head -${NLINE} cscucl31_kp.txt | tail -1 >> cscucl3-scf-${NLINE}.in
$MPIRUN -np $NSLOTS $PW < cscucl3-scf-${NLINE}.in > cscucl3-scf-${NLINE}.out
end
