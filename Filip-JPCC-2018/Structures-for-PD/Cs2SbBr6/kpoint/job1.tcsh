...
cp cs2sbbr6-scf.in cs2sbbr6-scf-${NLINE}.in
head -${NLINE} cs2sbbr61_kp.txt | tail -1 >> cs2sbbr6-scf-${NLINE}.in
$MPIRUN -np $NSLOTS $PW < cs2sbbr6-scf-${NLINE}.in > cs2sbbr6-scf-${NLINE}.out
end
