...
cp cs2sbaucl6-scf.in cs2sbaucl6-scf-${NLINE}.in
head -${NLINE} cs2sbaucl61_kp.txt | tail -1 >> cs2sbaucl6-scf-${NLINE}.in
$MPIRUN -np $NSLOTS $PW < cs2sbaucl6-scf-${NLINE}.in > cs2sbaucl6-scf-${NLINE}.out
end
