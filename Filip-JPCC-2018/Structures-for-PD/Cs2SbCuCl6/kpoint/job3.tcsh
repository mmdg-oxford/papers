...
cp cs2sbcucl6-scf.in cs2sbcucl6-scf-${NLINE}.in
head -${NLINE} cs2sbcucl61_kp.txt | tail -1 >> cs2sbcucl6-scf-${NLINE}.in
$MPIRUN -np $NSLOTS $PW < cs2sbcucl6-scf-${NLINE}.in > cs2sbcucl6-scf-${NLINE}.out
end
