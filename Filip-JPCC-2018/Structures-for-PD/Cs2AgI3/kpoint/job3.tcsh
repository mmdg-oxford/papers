...
cp cs2agi3-scf.in cs2agi3-scf-${NLINE}.in
head -${NLINE} cs2agi31_kp.txt | tail -1 >> cs2agi3-scf-${NLINE}.in
$MPIRUN -np $NSLOTS $PW < cs2agi3-scf-${NLINE}.in > cs2agi3-scf-${NLINE}.out
end
