...
cp csagcl3-scf.in csagcl3-scf-${NLINE}.in
head -${NLINE} csagcl31_kp.txt | tail -1 >> csagcl3-scf-${NLINE}.in
$MPIRUN -np $NSLOTS $PW < csagcl3-scf-${NLINE}.in > csagcl3-scf-${NLINE}.out
end
