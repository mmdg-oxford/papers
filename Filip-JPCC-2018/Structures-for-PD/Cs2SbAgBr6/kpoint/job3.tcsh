...
cp cs2sbagbr6-scf.in cs2sbagbr6-scf-${NLINE}.in
head -${NLINE} cs2sbagbr61_kp.txt | tail -1 >> cs2sbagbr6-scf-${NLINE}.in
$MPIRUN -np $NSLOTS $PW < cs2sbagbr6-scf-${NLINE}.in > cs2sbagbr6-scf-${NLINE}.out
end
