...
cp csaubr3-scf.in csaubr3-scf-${NLINE}.in
head -${NLINE} csaubr31_kp.txt | tail -1 >> csaubr3-scf-${NLINE}.in
$MPIRUN -np $NSLOTS $PW < csaubr3-scf-${NLINE}.in > csaubr3-scf-${NLINE}.out
end
