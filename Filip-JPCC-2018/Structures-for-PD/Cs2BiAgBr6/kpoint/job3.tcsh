...
cp cs2biagcl6-scf.in cs2biagcl6-scf-${NLINE}.in
head -${NLINE} cs2biagcl61_kp.txt | tail -1 >> cs2biagcl6-scf-${NLINE}.in
$MPIRUN -np $NSLOTS $PW < cs2biagcl6-scf-${NLINE}.in > cs2biagcl6-scf-${NLINE}.out
end
