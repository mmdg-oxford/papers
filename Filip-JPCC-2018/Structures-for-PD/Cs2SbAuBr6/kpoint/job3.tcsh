...
cp cs2sbaubr6-scf.in cs2sbaubr6-scf-${NLINE}.in
head -${NLINE} cs2sbaubr61_kp.txt | tail -1 >> cs2sbaubr6-scf-${NLINE}.in
$MPIRUN -np $NSLOTS $PW < cs2sbaubr6-scf-${NLINE}.in > cs2sbaubr6-scf-${NLINE}.out
end
