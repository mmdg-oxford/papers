...
cp biaubr6-scf.in biaubr6-scf-${NLINE}.in
head -${NLINE} biaubr61_kp.txt | tail -1 >> biaubr6-scf-${NLINE}.in
$MPIRUN -np $NSLOTS $PW < biaubr6-scf-${NLINE}.in > biaubr6-scf-${NLINE}.out
end
