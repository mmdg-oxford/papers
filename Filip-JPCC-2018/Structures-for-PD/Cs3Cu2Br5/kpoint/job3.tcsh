...
cp cs3cu2br5-scf.in cs3cu2br5-scf-${NLINE}.in
head -${NLINE} cs3cu2br51_kp.txt | tail -1 >> cs3cu2br5-scf-${NLINE}.in
$MPIRUN -np $NSLOTS $PW < cs3cu2br5-scf-${NLINE}.in > cs3cu2br5-scf-${NLINE}.out
end
