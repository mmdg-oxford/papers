...
cp cs3cu2cl5-scf.in cs3cu2cl5-scf-${NLINE}.in
head -${NLINE} cs3cu2cl51_kp.txt | tail -1 >> cs3cu2cl5-scf-${NLINE}.in
$MPIRUN -np $NSLOTS $PW < cs3cu2cl5-scf-${NLINE}.in > cs3cu2cl5-scf-${NLINE}.out
end
