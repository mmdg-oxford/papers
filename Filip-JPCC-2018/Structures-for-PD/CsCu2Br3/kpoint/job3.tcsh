...
cp cscu2br3-scf.in cscu2br3-scf-${NLINE}.in
head -${NLINE} cscu2br31_kp.txt | tail -1 >> cscu2br3-scf-${NLINE}.in
$MPIRUN -np $NSLOTS $PW < cscu2br3-scf-${NLINE}.in > cscu2br3-scf-${NLINE}.out
end
