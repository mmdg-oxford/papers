...
foreach NLINE ( `seq 1 30` )
cp cs2sbaui6-scf.in cs2sbaui6-scf-${NLINE}.in
head -${NLINE} cs2sbaui61_kp.txt | tail -1 >> cs2sbaui6-scf-${NLINE}.in
$MPIRUN -np $NSLOTS $PW < cs2sbaui6-scf-${NLINE}.in > cs2sbaui6-scf-${NLINE}.out
end
