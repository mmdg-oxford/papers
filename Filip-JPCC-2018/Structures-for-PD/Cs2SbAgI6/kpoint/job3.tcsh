...
cp cs2sbagi6-scf.in cs2sbagi6-scf-${NLINE}.in
head -${NLINE} cs2sbagi61_kp.txt | tail -1 >> cs2sbagi6-scf-${NLINE}.in
$MPIRUN -np $NSLOTS $PW < cs2sbagi6-scf-${NLINE}.in > cs2sbagi6-scf-${NLINE}.out
end
