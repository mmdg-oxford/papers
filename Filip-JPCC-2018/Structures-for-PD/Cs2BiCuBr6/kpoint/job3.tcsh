...
cp cs2bicubr6-scf.in cs2bicubr6-scf-${NLINE}.in
head -${NLINE} cs2bicubr61_kp.txt | tail -1 >> cs2bicubr6-scf-${NLINE}.in
$MPIRUN -np $NSLOTS $PW < cs2bicubr6-scf-${NLINE}.in > cs2bicubr6-scf-${NLINE}.out
end
