...
cp cs2sbcubr6-scf.in cs2sbcubr6-scf-${NLINE}.in
head -${NLINE} cs2sbcubr61_kp.txt | tail -1 >> cs2sbcubr6-scf-${NLINE}.in
$MPIRUN -np $NSLOTS $PW < cs2sbcubr6-scf-${NLINE}.in > cs2sbcubr6-scf-${NLINE}.out
end
