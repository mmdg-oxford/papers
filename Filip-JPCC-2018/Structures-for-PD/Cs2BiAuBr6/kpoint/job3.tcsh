...
cp cs2biaubr6-scf.in cs2biaubr6-scf-${NLINE}.in
head -${NLINE} cs2biaubr61_kp.txt | tail -1 >> cs2biaubr6-scf-${NLINE}.in
$MPIRUN -np $NSLOTS $PW < cs2biaubr6-scf-${NLINE}.in > cs2biaubr6-scf-${NLINE}.out
end
