...
cp cs3au2br11-scf.in cs3au2br11-scf-${NLINE}.in
head -${NLINE} cs3au2br111_kp.txt | tail -1 >> cs3au2br11-scf-${NLINE}.in
$MPIRUN -np $NSLOTS $PW < cs3au2br11-scf-${NLINE}.in > cs3au2br11-scf-${NLINE}.out
end
