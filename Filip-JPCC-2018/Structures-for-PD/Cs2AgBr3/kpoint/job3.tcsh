...
cp cs2agbr3-scf.in cs2agbr3-scf-${NLINE}.in
head -${NLINE} cs2agbr31_kp.txt | tail -1 >> cs2agbr3-scf-${NLINE}.in
$MPIRUN -np $NSLOTS $PW < cs2agbr3-scf-${NLINE}.in > cs2agbr3-scf-${NLINE}.out
end
