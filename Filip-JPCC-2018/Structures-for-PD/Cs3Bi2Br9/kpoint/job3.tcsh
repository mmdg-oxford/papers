...
cp cs3bi2br9-scf.in cs3bi2br9-scf-${NLINE}.in
head -${NLINE} cs3bi2br91_kp.txt | tail -1 >> cs3bi2br9-scf-${NLINE}.in
$MPIRUN -np $NSLOTS $PW < cs3bi2br9-scf-${NLINE}.in > cs3bi2br9-scf-${NLINE}.out
end
