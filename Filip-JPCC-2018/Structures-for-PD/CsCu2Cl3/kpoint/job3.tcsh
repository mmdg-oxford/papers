...
cp cscu2cl3-scf.in cscu2cl3-scf-${NLINE}.in
head -${NLINE} cscu2cl31_kp.txt | tail -1 >> cscu2cl3-scf-${NLINE}.in
$MPIRUN -np $NSLOTS $PW < cscu2cl3-scf-${NLINE}.in > cscu2cl3-scf-${NLINE}.out
end
