...
cp csagbr3-scf.in csagbr3-scf-${NLINE}.in
head -${NLINE} csagbr31_kp.txt | tail -1 >> csagbr3-scf-${NLINE}.in
$MPIRUN -np $NSLOTS $PW < csagbr3-scf-${NLINE}.in > csagbr3-scf-${NLINE}.out
end
