...
cp cs2bicui6-scf.in cs2bicui6-scf-${NLINE}.in
head -${NLINE} cs2bicui61_kp.txt | tail -1 >> cs2bicui6-scf-${NLINE}.in
$MPIRUN -np $NSLOTS $PW < cs2bicui6-scf-${NLINE}.in > cs2bicui6-scf-${NLINE}.out
end
