...
cp cs3sb2i9-scf.in cs3sb2i9-scf-${NLINE}.in
head -${NLINE} cs3sb2i91_kp.txt | tail -1 >> cs3sb2i9-scf-${NLINE}.in
$MPIRUN -np $NSLOTS $PW < cs3sb2i9-scf-${NLINE}.in > cs3sb2i9-scf-${NLINE}.out
end
