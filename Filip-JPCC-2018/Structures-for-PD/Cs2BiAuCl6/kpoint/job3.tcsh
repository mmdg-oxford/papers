...
cp cs2biaucl6-scf.in cs2biaucl6-scf-${NLINE}.in
head -${NLINE} cs2biaucl61_kp.txt | tail -1 >> cs2biaucl6-scf-${NLINE}.in
$MPIRUN -np $NSLOTS $PW < cs2biaucl6-scf-${NLINE}.in > cs2biaucl6-scf-${NLINE}.out
end
