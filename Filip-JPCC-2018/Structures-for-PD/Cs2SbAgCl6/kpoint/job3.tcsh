...
cp cs2sbagcl6-scf.in cs2sbagcl6-scf-${NLINE}.in
head -${NLINE} cs2sbagcl61_kp.txt | tail -1 >> cs2sbagcl6-scf-${NLINE}.in
$MPIRUN -np $NSLOTS $PW < cs2sbagcl6-scf-${NLINE}.in > cs2sbagcl6-scf-${NLINE}.out
end
