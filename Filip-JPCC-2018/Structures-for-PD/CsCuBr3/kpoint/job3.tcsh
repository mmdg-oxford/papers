...
cp cscubr3-scf.in cscubr3-scf-${NLINE}.in
head -${NLINE} cscubr31_kp.txt | tail -1 >> cscubr3-scf-${NLINE}.in
$MPIRUN -np $NSLOTS $PW < cscubr3-scf-${NLINE}.in > cscubr3-scf-${NLINE}.out
end
