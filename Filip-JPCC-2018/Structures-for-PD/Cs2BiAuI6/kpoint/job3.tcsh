...
cp cs2biaui6-scf.in cs2biaui6-scf-${NLINE}.in
head -${NLINE} cs2biaui61_kp.txt | tail -1 >> cs2biaui6-scf-${NLINE}.in
$MPIRUN -np $NSLOTS $PW < cs2biaui6-scf-${NLINE}.in > cs2biaui6-scf-${NLINE}.out
end
