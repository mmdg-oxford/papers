...
cp cs3bicl6-scf.in cs3bicl6-scf-${NLINE}.in
head -${NLINE} cs3bicl61_kp.txt | tail -1 >> cs3bicl6-scf-${NLINE}.in
$MPIRUN -np $NSLOTS $PW < cs3bicl6-scf-${NLINE}.in > cs3bicl6-scf-${NLINE}.out
end
