...
head -5 ../structure/*.vasp | tail -3 > tmp3.dat

cat na-scf.in tmp3.dat atomicpos.in tmp4.dat tail.in > cs3bi2i9-scf.in

rm na-scf.in tmp.dat tmp2.dat tmp3.dat atomicpos.in tmp4.dat tail.in
