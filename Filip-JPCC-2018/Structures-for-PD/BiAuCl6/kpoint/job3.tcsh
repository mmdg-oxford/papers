...
cp biaucl6-scf.in biaucl6-scf-${NLINE}.in
head -${NLINE} biaucl61_kp.txt | tail -1 >> biaucl6-scf-${NLINE}.in
$MPIRUN -np $NSLOTS $PW < biaucl6-scf-${NLINE}.in > biaucl6-scf-${NLINE}.out
end
